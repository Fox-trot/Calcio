...
Функция БуферНовостей() Экспорт
	Возврат Константы.БуферНовостей.Получить();
КонецФункции
...
Функция ИмпортМатча(Гиперссылка, Матч) Экспорт
	Ответ	= Ложь;
...
Функция ЗапуститьРегламентноеЗадание(Имя="ИмпортИгр") Экспорт
	Регламент	= Метаданные.РегламентныеЗадания.Найти(Имя);
