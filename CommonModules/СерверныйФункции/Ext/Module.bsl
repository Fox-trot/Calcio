...
Функция ПоОлимпийскойСистеме(ЧемпионатИлиЛига) Экспорт
	Возврат ?(ТипЗнч(ЧемпионатИлиЛига) = Тип("СправочникСсылка.Лига"), ЧемпионатИлиЛига.ПоОлимпийскойСистеме, ЧемпионатИлиЛига.Владелец.ПоОлимпийскойСистеме);
КонецФункции
