	...
	Если НЕ Результат.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Иначе
				...
				ИначеЕсли НачалоДня(Выборка.Дата + Сдвиг) = НачалоДня(Дата + Сутки()) Тогда
					Туча.Дата		= "Завтра " + Формат(Выборка.Дата + Сдвиг, "ДФ='HH:mm'");
				ИначеЕсли НачалоДня(Выборка.Дата + Сдвиг) = НачалоДня(Дата) Тогда
					Туча.Дата		= "Сегодня " + Формат(Выборка.Дата + Сдвиг, "ДФ='HH:mm'");
				Иначе
