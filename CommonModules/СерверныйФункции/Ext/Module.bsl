...
Процедура ЗаголовокВывести(ТабДокумент, Параметры) Экспорт
	...
	Тогда
		Чемпион= СерверныйФункции.Чемпион(Параметры.Чемпионат);
		Если ЗначениеЗаполнено(Чемпион) Тогда
			Изображение	= СерверныйФункции.ИзображениеПолучить(Чемпион, Истина);
...
Процедура КартинкаУстановить(ОбластьМакета, Команда) Экспорт
