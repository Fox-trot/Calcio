...
Процедура ПередЗаписью(Отказ)
	Если ПустаяСтрока(Комментарий) Тогда
		...
		Если СтрНайти(Наименование, Город.Наименование) = 0 Тогда
			Комментарий = Комментарий + Символы.ПС + СтрШаблон("%1 (%2)", СокрЛП(Наименование), Город.Наименование);
		КонецЕсли;
		Варианты = Варианты(Наименование);
		Если НЕ ПустаяСтрока(Варианты) Тогда
			Комментарий = Комментарий + Символы.ПС + Варианты;
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
