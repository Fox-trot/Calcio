...
Процедура График2ОбновитьНаСервере()
	...
	Пока Выборка.Следующий() Цикл
		...
		График2.УстановитьЗначение(Точка, Серия1, Выборка.Фаза1, Выборка.Игрок);
		График2.УстановитьЗначение(Точка, Серия2, Выборка.Фаза2, Выборка.Игрок);
		График2.УстановитьЗначение(Точка, Серия3, Выборка.Фаза3, Выборка.Игрок);
	КонецЦикла;
КонецПроцедуры
