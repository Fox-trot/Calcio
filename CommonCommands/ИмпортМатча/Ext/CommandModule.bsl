	...
	Для Каждого Слово Из Слова Цикл
		...
		ИначеЕсли СтрЧислоСтрок(Слово) = 1 Тогда
			Если СтрНайти(Слово, ":") > 0 Тогда
				Если СтрСравнить(СтрЗаменить(Слово, ":", ""), "Наказания") = 0 Тогда
					Прервать;
				ИначеЕсли СтрСравнить(СтрЗаменить(Слово, ":", ""), "Тренеры") = 0 Тогда
					Прервать;
...
Функция СоставыКомандДобавить(Слово, Индекс, сМатч)
	...
	Если Игрок = Неопределено Тогда
		Возврат Ложь;
	КонецЕсли;
	сМатч.СоставыКоманд.Добавить(Новый Структура("Игрок,Команда", Игрок, сМатч.Команды.Получить(Индекс)));
	Возврат Истина;
КонецФункции
