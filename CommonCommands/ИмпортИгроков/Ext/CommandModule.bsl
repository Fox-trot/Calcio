...
Функция ИмпортНаСервере(Гиперссылка, Команда)
	Возврат ?(ГодПолучить(Гиперссылка) >= 2022, СерверныйФункции.ИмпортИгроковНаСервере(Гиперссылка, Команда), СерверныйФункции.ИмпортИгроковНаСервере2(Гиперссылка, Команда));
КонецФункции
...
&НаСервере
Функция ГодПолучить(Гиперссылка)
	Возврат СерверныйФункции.ГодПолучить(Гиперссылка);
КонецФункции
