...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТипГрафика.СписокВыбора.Добавить(1, "Количество голов");
	Элементы.ТипГрафика.СписокВыбора.Добавить(2, "Средняя результативность");
	Элементы.ТипГрафика.СписокВыбора.Добавить(3, "Разница голов");
	...
	Элементы.ТипГрафика.СписокВыбора.Добавить(12, "Количество голов по месяцам");
