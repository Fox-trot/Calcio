	...
	Если ЗначениеЗаполнено(Отчет.Команда) Тогда
		Если ТипГрафика = 6 Тогда
			Для Каждого Детали Из Отчет.Данные Цикл
				...
				График.УстановитьЗначение(Точка, График.УстановитьСерию("Забито"), Детали.КоличествоЗабито, Детали.Матч);
			...
			Для Итератор = 0 По 1 Цикл
				...
				Для Каждого Детали Из Отчет.Данные Цикл
					...
					Если Итератор = 0 Тогда
						График.УстановитьЗначение(Точка, График.УстановитьСерию("Набрано"), Итого, Детали.Матч);
						График.УстановитьЗначение(Точка, График.УстановитьСерию("В среднем"), Окр(Итого / График.КоличествоТочек, 2));
					Иначе
						График.УстановитьЗначение(Точка, График.УстановитьСерию("Упущено"), Итого, Детали.Матч, Детали.Подсказка);
					КонецЕсли;
				КонецЦикла;
			КонецЦикла;
