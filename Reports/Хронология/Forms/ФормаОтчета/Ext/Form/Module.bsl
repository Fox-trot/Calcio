	...
	Если ЗначениеЗаполнено(Отчет.Команда) Тогда
		Если ТипГрафика = 9 Тогда
			Запрос.Текст = "ВЫБРАТЬ
			               ...
			               |		КОГДА ТурнирнаяТаблица.НомерСтроки = 1
			               |			ТОГДА 0
			               |		ИНАЧЕ 0 - ТурнирнаяТаблица.КоличествоГолов
...
Процедура ГрафикОбновить()
	...
	ИначеЕсли ТипГрафика = 9 Тогда
		...
		Гости	= УстановитьСерию("Гости");
		Для Каждого Детали Из Отчет.Данные Цикл
			График.УстановитьЗначение(УстановитьТочку(Детали.Подсказка), Хозяева, Детали.КоличествоЗабито);
			График.УстановитьЗначение(УстановитьТочку(Детали.Подсказка), Гости, Детали.КоличествоПропущено);
		КонецЦикла;
	ИначеЕсли ТипГрафика = 8 Тогда
		Для Каждого Детали Из Отчет.Данные Цикл
