	...
	Если ЗначениеЗаполнено(Отчет.Команда) Тогда
		Если ТипГрафика = -1 Тогда
			...
			Для Каждого Детали Из Отчет.Данные Цикл
				...
				График.УстановитьЗначение(Тур, Серия0, Детали.КоличествоПропущено, Детали.Матч, Детали.Матч);
				График.УстановитьЗначение(Тур, Серия1, Детали.КоличествоЗабито, Детали.Матч);
			КонецЦикла;
		ИначеЕсли ТипГрафика = 11 Тогда
			СерииЗаполнить();
			Для Каждого Детали Из Отчет.Данные Цикл
