...
Процедура ЧемпионатПриИзмененииНаСервере()
	КомандыЧемпионата.ЗагрузитьЗначения(КомандыЧемпионата());
	Элементы.Команда.СписокВыбора.ЗагрузитьЗначения(СерверныйФункции.КомандыЛиги(Отчет.Чемпионат.Владелец, Истина));
	Если ЗначениеЗаполнено(Отчет.Команда) Тогда
