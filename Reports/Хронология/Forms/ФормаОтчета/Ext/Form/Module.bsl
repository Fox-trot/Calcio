...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТипГрафика.СписокВыбора.Добавить(3, "Беспроигрышная серия");
	Элементы.ТипГрафика.СписокВыбора.Добавить(4, "Победная серия");
	Элементы.ТипГрафика.СписокВыбора.Добавить(5, "'Сухая' серия");
	Элементы.ТипГрафика.СписокВыбора.Добавить(6, "'Сухие' матчи");
	Элементы.ТипГрафика.СписокВыбора.Добавить(7, "'Сухие' победы");
	Элементы.ТипГрафика.СписокВыбора.Добавить(8, "Зрелищность");
	Элементы.ТипГрафика.СписокВыбора.Добавить(9, "Дома/Выезд");
	Элементы.ТипГрафика.СписокВыбора.Добавить(10, "Количество очков по месяцам");
	Элементы.ТипГрафика.СписокВыбора.Добавить(11, "Количество голов по месяцам");
...
Процедура ГрафикВыбор(Элемент, ЗначениеДиаграммы, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ЗначениеДиаграммы) = Тип("ЗначениеДиаграммы") Тогда
		Если СтрНайти("3,4,5,10,11", ФорматЧГ(ТипГрафика)) > 0 Тогда
