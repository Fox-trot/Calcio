...
Процедура ДанныеПолучить()
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |	ГОД(Итоги.Период) КАК Год,
	                      |	Итоги.Команда КАК Команда,
	                      |	Итоги.КоличествоОчков КАК КоличествоОчков,
	                      |	Итоги.КоличествоЗабито - Итоги.КоличествоПропущено КАК Разница,
...
Процедура ЛигаПриИзмененииНаСервере()
	...
	Элементы.Команда.СписокВыбора.ЗагрузитьЗначения(?(ЗначениеЗаполнено(Отчет.Лига), СерверныйФункции.КомандыЛиги(Отчет.Лига, Истина), Новый Массив));
КонецПроцедуры
