		...
		Пока Туры.Следующий() Цикл
			...
			Пока Выборка.Следующий() Цикл
				...
				Если ВыводитьЛоготипыКоманд Тогда
					ОбластьМакета.Параметры.Команда		= СтрКоротко(Выборка.Команда);
					ОбластьМакета.Параметры.Команда2	= СтрКоротко(Выборка.Команда2);
...
Функция СтрКоротко(Команда)
	Если СтрДлина(Команда.Наименование) > 11 Тогда
		Если СтрНайти(Команда.Наименование, " ") = 0 Тогда
			Возврат Лев(Команда.Наименование, 11);
		Иначе
			Ответ	= "";
			Слова	= Разделить(Команда.Наименование);
			Если СтрДлина(Слова.Получить(0)) > 11 Тогда
				Ответ	= Лев(Слова.Получить(0), 11);
			Иначе
