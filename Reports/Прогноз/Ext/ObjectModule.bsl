...
Функция ДанныеПолучить(Все=Ложь) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	               ...
	               |	КОНЕЦ КАК Результат,
	               |	ВЫБОР
	               |		КОГДА ВТ.Фаза1 + ВТ.Фаза2 + ВТ.Фаза3 + ВТ.Корреляция - ВТ2.Фаза1 - ВТ2.Фаза2 - ВТ2.Фаза3 - ВТ2.Корреляция >= 0
	               |			ТОГДА ВТ.Фаза1 + ВТ.Фаза2 + ВТ.Фаза3 + ВТ.Корреляция - ВТ2.Фаза1 - ВТ2.Фаза2 - ВТ2.Фаза3 - ВТ2.Корреляция
	               |		ИНАЧЕ ВТ2.Фаза1 + ВТ2.Фаза2 + ВТ2.Фаза3 + ВТ2.Корреляция - ВТ.Фаза1 - ВТ.Фаза2 - ВТ.Фаза3 - ВТ.Корреляция
	               |	КОНЕЦ КАК Разница,
