...
Процедура ЧемпионатНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	НаКлиенте.ОбработкаКомандыОткрытьФорму("Справочник.Чемпионаты.ФормаВыбора", Новый Структура("РежимВыбора,ТекущаяСтрока,Отбор,ТолькоТекущие", Истина, Отчет.Чемпионат, Новый Структура("Ссылка", Чемпионаты.ВыгрузитьЗначения()), Истина), Элемент, СтандартнаяОбработка);
КонецПроцедуры
